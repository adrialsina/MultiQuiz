...
import static edu.upc.eseiaat.pma.multiquiz.R.string.incorrect;
            ...
            public void onClick(View v) {
                ...
                if(current_question < all_questions.length-1){
                   ...
                   int correct = 0, incorrect = 0;
                    ...
                    String results =
                            String.format("Correct: %d -- Incorrect: %d", correct, incorrect);
                    Toast.makeText(multiquiz.this, results, Toast.LENGTH_LONG).show();
                    finish();
                }
                /*
                for (int i = 0; i< answer_is_correct.length; i++){
                    Log.i("adria", String.format("Resposta %d: %b", i, answer_is_correct[i] ));
